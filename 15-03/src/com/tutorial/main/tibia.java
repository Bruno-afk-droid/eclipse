...
public class tibia extends Part {
	...
	public tibia(int x, int y,int[] SW,int[] SH,int[] SD,int[] layers, ID id,int px,int py,int pz,GameObject owner,Handler handler) {
		...
		//addPart(new tibia(x,y-16,new int[] {-32,32,32,-32},new int[] {-8,-8,8,8},ID.tibia, 63,0,this,handler));
		//addPart(new tibia(x,y-16,new int[] {-32,32,32,-32},new int[] {-8,-8,8,8},ID.tibia, 63,-20,this,handler));
	}
